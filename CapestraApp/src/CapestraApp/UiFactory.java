...
/**
 *
 * @author Ikemtz The purpose of this class is to simplify the creation of UI
 * controls Eliminating dozens of lines of code from the CapestraApp.java class
 */
public final class UiFactory {

    // Default Inset values to standardize the appearance of scenes
    public static Insets DEFAULT_INSETS = new Insets(25, 50, 15, 50);
   ...
   * case (ie: firstname, productDescription)
    ...
    public static HBox createCommandHBox(Button... buttons) {       
        HBox commandHB = new HBox(buttons);
        commandHB.setSpacing(10);
        commandHB.alignmentProperty().setValue(Pos.CENTER);
        return commandHB;
    }
}
